...
<head>
    ...
    <title>@yield('title', 'SeasideWorld - Premium Japanese Vehicle Exports')</title>
    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="mainNav">
            <ul class="navbar-nav mx-auto gap-1">
                ...
                <li class="nav-item">
                    <a class="nav-link {{ request()->routeIs('export-process') ? 'active' : '' }}" href="{{ route('export-process') }}">
                        {{ __('messages.export_process') }}
                    </a>
                </li>
                <li class="nav-item">
            ...
            <div class="d-flex align-items-center gap-2">
                ...
                <div class="lang-switcher d-flex gap-1 me-2">
                    <form action="{{ route('language.switch', 'en') }}" method="POST">
                        @csrf
                        <button type="submit" class="btn-lang {{ app()->getLocale() === 'en' ? 'active-lang' : '' }}">EN</button>
                    </form>
                    <form action="{{ route('language.switch', 'jp') }}" method="POST">
                        @csrf
                        <button type="submit" class="btn-lang {{ app()->getLocale() === 'jp' ? 'active-lang' : '' }}">JP</button>
                    </form>
                </div>
                    ...
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end">
                            @if(auth()->user()->role === 'admin')
                                <li><a class="dropdown-item" href="{{ route('admin.dashboard') }}"><i class="fa fa-tachometer-alt me-2"></i>Admin Panel</a></li>
                            @else
                                <li><a class="dropdown-item" href="{{ route('client.dashboard') }}"><i class="fa fa-home me-2"></i>Dashboard</a></li>
                            @endif
                ...
                @else
                    @guest
                        <a href="{{ route('login') }}" class="btn btn-sm" style="background: var(--ocean-teal); color: #fff; border: none; padding: 0.4rem 1rem; border-radius: 6px; font-weight: 500;">
    ...
    <div class="container">
        <div class="row g-4">
            ...
            <div class="col-lg-2 col-md-6">
                ...
                <ul class="list-unstyled" style="line-height: 2;">
                    <li><a href="{{ route('home') }}"><i class="fa fa-chevron-right me-1" style="font-size:0.7rem; color: var(--ocean-teal);"></i>{{ __('messages.home') }}</a></li>
                    <li><a href="{{ route('about') }}"><i class="fa fa-chevron-right me-1" style="font-size:0.7rem; color: var(--ocean-teal);"></i>{{ __('messages.about') }}</a></li>
                    <li><a href="{{ route('services') }}"><i class="fa fa-chevron-right me-1" style="font-size:0.7rem; color: var(--ocean-teal);"></i>{{ __('messages.services') }}</a></li>
                    <li><a href="{{ route('gallery') }}"><i class="fa fa-chevron-right me-1" style="font-size:0.7rem; color: var(--ocean-teal);"></i>{{ __('messages.gallery') }}</a></li>
                    <li><a href="{{ route('export-process') }}"><i class="fa fa-chevron-right me-1" style="font-size:0.7rem; color: var(--ocean-teal);"></i>{{ __('messages.export_process') }}</a></li>
                    <li><a href="{{ route('contact') }}"><i class="fa fa-chevron-right me-1" style="font-size:0.7rem; color: var(--ocean-teal);"></i>{{ __('messages.contact') }}</a></li>
                </ul>
            </div>
        ...
        <div class="footer-bottom text-center">
            <p class="mb-0" style="font-size: 0.88rem;">
                &copy; {{ date('Y') }} SeasideWorld. All rights reserved. &nbsp;|&nbsp;
